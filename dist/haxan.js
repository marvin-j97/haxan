(function (global, factory) {
     ...
     */
    var HaxanError = /** @class */ (function (_super) {
     ...
     */
    var HaxanTimeout = /** @class */ (function (_super) {
     ...
     */
    var HaxanRejection = /** @class */ (function (_super) {
     ...
     */
    var HaxanAbort = /** @class */ (function (_super) {
    ...
    var HaxanFactory = /** @class */ (function () {
        function HaxanFactory(url, opts) {
            this._opts = {
                ...
                rejectOn: function () { return false; },
                        ...
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.race([
                                    ...
                                    new Promise(function (_, reject) {
                                        return setTimeout(function () { return reject(new HaxanTimeout()); }, _this._opts.timeout);
                                    }),
                                ])];
                        case 1:
                            res = _d.sent();
                            ...
                            if (!(this._opts.type === ResponseType.Auto)) return [3 /*break*/, 3];
                            _a = {};
                            return [4 /*yield*/, this.parseBody(res)];
                        case 2: return [2 /*return*/, (_a.data = _d.sent(),
                                _a.ok = res.ok,
                                _a.status = res.status,
                                _a.headers = resHeaders,
                                _a)];
                        case 3:
                            if (!(this._opts.type === ResponseType.Json)) return [3 /*break*/, 5];
                            _b = {};
                            return [4 /*yield*/, res.json()];
                        case 4: return [2 /*return*/, (_b.data = _d.sent(),
                                _b.ok = res.ok,
                                _b.status = res.status,
                                _b.headers = resHeaders,
                                _b)];
                        case 5:
                            if (!(this._opts.type === ResponseType.Text)) return [3 /*break*/, 7];
                            _c = {};
